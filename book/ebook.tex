...
%\def \EnableTextRevisionVersion{}

\ifdefined \EnableTextRevisionVersion
...
\ifx\EnableTextRevisionVersion\undefined
    % Habilitando imagenes en el libro
    \def \EnableIncludeImages{}
\fi
...
\newcommand{\imprimirdata}[0]{novembro de \imprimiryear}
...
\newcommand{\imprimirisbn}[0]{978-65-00-13175-8}
...
\hyphenation{co-zi-nha-va}
\hyphenation{co-zi-nha}
\hyphenation{a-com-pa-nhan-do} 
\hyphenation{mi-nha} 
\hyphenation{ni-nho} 
\hyphenation{ti-nha} 
...
%	PREFACIO
%----------------------------------------------------------------------------------------
\input{\SourceRootPath/preliminares/prefacio}
...
%----------------------------------------------------------------------------------------
\input{\SourceRootPath/chapters/intro/intro}
...
%	CHAPTER ONE
%----------------------------------------------------------------------------------------
\input{\SourceRootPath/chapters/cap-zorra/cap-zorra}

%----------------------------------------------------------------------------------------
%	CHAPTER TWO
%----------------------------------------------------------------------------------------

\input{\SourceRootPath/chapters/cap-zandor/cap-zandor}
